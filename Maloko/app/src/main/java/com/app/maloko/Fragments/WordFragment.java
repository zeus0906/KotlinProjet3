...
import com.app.maloko.databinding.FragmentWordBinding;
...
public class WordFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView= view.findViewById(R.id.GridRecycleView);
    ...
    private void dataInitialized() {
        ...
        list.add(new Category(R.drawable.couleur_transport,"Les Transport & Couleur"));
        list.add(new Category(R.drawable.plus,"Autres"));
